...
<<<<<<< HEAD
    ...
    override func viewDidLoad() {
       ...
       // if type == textConstants.mapViewTitle{
...
>>>>>>> 184bd34b5724c0f20dae96c6d8cbe2a57b4c26e8
...
<<<<<<< HEAD
        ...
        for index in 0..<imageArray.count {
            detailimageView.af.setImage(withURL: URL(string:imageArray[index].file_urls.fullsize)!)
        }
        scrollingView.delegate = self
    }
    ...
    func setupScreens() {
        ...
        for index in 0..<imageArray.count {
           ...
           // imgView.image = UIImage(named: imageArray[index])
